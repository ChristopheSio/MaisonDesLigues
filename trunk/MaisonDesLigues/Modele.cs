...
namespace MaisonDesLigues
{
    ...
    static class Modele
    {
        ...
        /// <summary>Procédure publique qui va appeler la procédure stockée permettant d'inscrire un nouvel intervenant sans nuité</summary>
        ...
        static public void InscrireIntervenant(String pNom, String pPrenom, String pAdresse1, String pAdresse2, String pCp, String pVille, String pTel, String pMail, String pIdAtelier, String pIdStatut)
        {
            ...
            try {
                SqlCommand command = new SqlCommand("PSnouvelintervenant", DataBaseConnection);
        ...
        /// <summary>Procédure publique qui va appeler la procédure stockée permettant d'inscrire un nouvel intervenant qui aura des nuités</summary>
        static public void InscrireLicencie(String pNom, String pPrenom, String pAdresse1, String pAdresse2, String pCp, String pVille, String pTel, String pMail, Int16 pIdAtelier, String pIdStatut)
        {
            String MessageErreur = "";
            SqlTransaction transaction = DataBaseConnection.BeginTransaction();
            try {
        ...
        /// <summary>Procédure publique qui va appeler la procédure stockée permettant d'inscrire un nouvel intervenant qui aura des nuités</summary>
        static public void InscrireBenevole(String pNom, String pPrenom, String pAdresse1, String pAdresse2, String pCp, String pVille, String pTel, String pMail, Int16 pIdAtelier, String pIdStatut)
        {
            String MessageErreur = "";
            SqlTransaction transaction = DataBaseConnection.BeginTransaction();
            try {
